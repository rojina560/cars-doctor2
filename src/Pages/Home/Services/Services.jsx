    ...
    return (
        <div className='mt-4'>
            <div className='text-center'>
                ...
                <p className='text-gray-400 mt-2'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni officia tenetur iure ducimus perspiciatis <br />illum numquam quasi cupiditate iste facere.</p>
            </div>
